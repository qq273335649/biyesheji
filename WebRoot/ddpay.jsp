		...
		<div class="container">
			...
			<div class="info">支付金额：	<%=ddprice %> 元</div>
						...
						<div class="tab-content" id="tags">
							...
							<form name="form1" id="ff1" method="post" action="/wsbooksys/wsbooksys?ac=pay&ddid=<%=ddid %>">
							...
							<div id="tagContent1" class="tab-pane fade">
							  <form name="form2" id="ff2" method="post" action="/wsbooksys/wsbooksys?ac=pay&ddid=<%=ddid %>">
								<div class="form-group">
