...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/wsbooksys/admin/goodsgl.jsp?1=1";
        ...
        <tr>
          ...
          <td>
              <%
			    ...
			    <a href="admin/goodsgl.jsp?tjid=<%=map.get("id") %>" title="推荐"><i class="icon-thumbs-up"></i></a>
			    <%}else{ %>
			    <a href="admin/goodsgl.jsp?qxtjid=<%=map.get("id") %>" title="取消推荐"><i class="icon-thumbs-down"></i></a>
			    <%} %>
...
<div class="pagination">
    ...
    <script type="text/javascript">
        ...
        function Change_Select(){//当第一个下拉框的选项发生改变时调用该函数
          ...
          var url = "/wsbooksys/wsbooksys?ac=searchsontype&fprotype="+ escape(fprotype);
