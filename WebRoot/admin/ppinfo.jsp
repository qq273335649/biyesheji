...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/wsbooksys/admin/ppinfo.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/ppinfo.jsp?f=f" method="post" class="form-inline">
							<input class="input-xlarge" placeholder="出版社名称..." id="key" name="key" type="text" value="<%=key %>">
		                    <button class="btn" type="submit"><i class="icon-search"></i> Go</button>
						    <button class="btn btn-primary" onclick="ppinfoadd()" type="button"><i class="icon-plus"></i> 出版社</button>
						</form>	
					</div>  	
				</div>
